...
<title>CATEGORIA GORROS</title> <!-- Título de la página -->
        ...
        <div class="fila"> <!-- Un div con la clase "fila" -->
            ...
            <div class="item" onclick="cargar(this)">
                <div class="contenedor-foto">
                    <img src="img/gorroclasico.png" alt="">
                </div>
                <p class="descripcion">Gorro Tejido de Lana Clásico</p>
                <span class="precio">$ 30.000</span>
                <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Gorro Tejido de Lana Clásica', 30000,'img/gorroclasico.png')">Agregar al Carrito</button>
            </div>
          <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                        <img src="img/gorrobeanie.png" alt="">
                    </div>
                    <p class="descripcion">Gorro Beanie Tejido Básico</p>
                    <span class="precio">$ 38.000</span>
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Gorro Beanie Tejido Básico', 38000,'img/gorrobeanie.png')">Agregar al Carrito</button>
                </div>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                        <img src="img/gorroligero.png" alt="">
                    </div>
                    <p class="descripcion">Gorro de Hilo Ligero</p>
                    <span class="precio">$ 35.000</span>
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Gorro de Hilo Ligero', 35000,'img/gorroligero.png')">Agregar al Carrito</button>
                </div>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                        <img src="img/gorrooversize.png" alt="">
                    </div>
                    <p class="descripcion">Gorro Tejido Oversize</p>
                    <span class="precio">$ 35.000</span>
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Gorro Tejido Oversize', 35000,'img/gorrooversize.png')">Agregar al Carrito</button>
                </div>
            </div>
            <div class="fila">
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                        <img src="img/gorrodoblez.png" alt="">
                    </div>
                    <p class="descripcion">Gorro de Lana con Doblez</p>
                    <span class="precio">$ 40.000</span>
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Gorro de Lana con Doblez', 40000,'img/gorrodoblez.png')">Agregar al Carrito</button>
                </div>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                        <img src="img/gorrocasual.png" alt="">
                    </div>
                    <p class="descripcion">Gorro Tejido Estilo Casual</p>
                    <span class="precio">$ 38.000</span>
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Gorro Tejido Estilo Casual', 38000,'img/gorrocasual.png')">Agregar al Carrito</button>
                </div>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                        <img src="img/gorrogrueso.png" alt="">
                    </div>
                    <p class="descripcion">Gorro Tejido con Textura Gruesa</p>
                    <span class="precio">$ 42.000</span>
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Gorro Tejido con Textura Gruesa', 42000,'img/gorrogrueso.png')">Agregar al Carrito</button>
                </div>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                        <img src="img/gorroelegante.png" alt="">
                    </div>
                    <p class="descripcion">Gorro Tejido Elegante Minimalista</p>
                    <span class="precio">$ 45.000</span>
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Gorro Tejido Elegante Minimalista', 45000,'img/agorroelegante.png')">Agregar al Carrito</button>
                </div>
            </div> 
        </div>
