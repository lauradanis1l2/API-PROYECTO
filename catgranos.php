    ...
    <div class="mostrador" id="mostrador"> <!-- Un div con la clase "mostrador" y un atributo "id" de "mostrador" -->
        <div class="fila"> <!-- Un div con la clase "fila" -->
            ...
            <div class="item" onclick="cargar(this)">
                ...
                <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('ARROZ DIANA', 1300,'img/arrozdian.png')">Agregar al Carrito</button>
            </div>
          <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                ...
                <div class="item" onclick="cargar(this)">
                    ...
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('ARROZ ROA', 3600,'img/arroz roa.png')">Agregar al Carrito</button>
                </div>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                    ...
                    <span class="precio">$ 1.800</span>
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('FRIJOL DIANA BOLA ROJA', 1800,'img/frijoldiana.png')">Agregar al Carrito</button>
                </div>
            </div>
            <div class="fila">
                <div class="item" onclick="cargar(this)">
                    ...
                    <span class="precio">$ 1.300</span>
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('MAIZ PIRA', 1300,'img/maizpira.png')">Agregar al Carrito</button>
                </div>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                    ...
                    <button class="agregar-al-carrito-btn"onclick="agregarAlCarrito('PASTA CLASICA TALLERIN DORIA ', 2000,'img/pastatallarindoria.png')">Agregar al Carrito</button>
                </div>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                    ...
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('PASTA MACARRON DORIA', 2500,'img/pastamacarrondoria.png')">Agregar al Carrito</button>
                </div>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                    ...
                    <span class="precio">$ 1.800</span>
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('LENTEJAS DIANA', 1800,'img/lentejasdiana.png')">Agregar al Carrito</button>
                </div>
            </div> 
        </div>
