        ...
        <div class="fila"> <!-- Un div con la clase "fila" -->
            ...
            <div class="item" onclick="cargar(this)"> <!-- Un div con la clase "item" y un atributo "onclick" -->
                <div class="contenedor-foto"> <!-- Un div con la clase "contenedor-foto" -->
                    <img src="img/scrubbasico.png" alt=""> <!-- Una imagen con una ruta "src" y una descripción alternativa "alt" -->
                </div> <!-- Cierre del div "contenedor-foto" -->
                <p class="descripcion">Uniforme Médico Clásico</p> <!-- Un párrafo con la clase "descripcion" -->
                <span class="precio">$ 130.000</span> <!-- Un span con la clase "precio" -->
                <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Uniforme Médico Clásico', 130000,'img/scrubbasico.png')">Agregar al Carrito</button>
            ...
            <div class="item" onclick="cargar(this)">
                <div class="contenedor-foto">
                    <img src="img/conjuntoantifluidos.png" alt="">
                </div>
                <p class="descripcion">Conjunto Antifluidos Profesional</p>
                <span class="precio">$ 120.000</span>
                <button  class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Conjunto Antifluidos Profesional', 12000,'img/conjuntoantifluidos.png')">Agregar al Carrito</button>
            </div>

            <!-- Tercer elemento -->
            <div class="item" onclick="cargar(this)">
                <div class="contenedor-foto">
                    <img src="img/medicoslimfit.png" alt="">
                </div>
                <p class="descripcion">Uniforme Médico Slim Fit</p>
                <span class="precio">$ 120.000</span>
                <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Uniforme Médico Slim Fit', 120000,'img/medicoslimfit.png')">Agregar al Carrito</button>
            </div>

            <!-- Cuarto elemento -->
            <div class="item" onclick="cargar(this)">
                <div class="contenedor-foto">
                    <img src="img/medicocargo.png" alt="">
                </div>
                <p class="descripcion">Pantalón Médico Cargo</p>
                <span class="precio">$ 80.000</span>
                <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Crema Pantalón Médico Cargo.4', 80000,'img/medicocargo.png')">Agregar al Carrito</button>
            </div>
...
<div class="fila">
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                        <img src="img/batamedica.png" alt="">
                    </div>
                    <p class="descripcion">Bata Médica Blanca Clásica </p>
                    <span class="precio">$ 80.000</span>
                    <button  class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Bata Médica Blanca Clásica', 80000,'img/batamedica.png')">Agregar al Carrito</button>
                </div>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                        <img src="img/blusamedica.png" alt="">
                    </div>
                    <p class="descripcion">Blusa Médica Antifluidos </p>
                    <span class="precio">$ 70.000</span>
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Blusa Médica Antifluidos', 70000,'img/blusamedica.png')">Agregar al Carrito</button>
                </div>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                        <img src="img/medicounisex.png" alt="">
                    </div>
                    <p class="descripcion">Uniforme Quirúrgico Unisex</p>
                    <span class="precio">$ 130.000</span>
                <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Uniforme Quirúrgico Unisex', 13000,'img/medicounisex.png')">Agregar al Carrito</button>
                </div>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                        <img src="img/deportivo.png" alt="">
                    </div>
                    <p class="descripcion">Conjunto Médico Deportivo</p>
                    <span class="precio">$ 120.000</span>
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Conjunto Médico Deportivo', 120000,'img/deportivo.png')">Agregar al Carrito</button>
                </div>
            </div> 
        </div>
