...
<title>CATEGORIA LACTEOS Y EMBUTIDOS</title> <!-- Título de la página -->
</head> <!-- Fin de la cabeza del documento -->
    ...
    <div class="mostrador" id="mostrador"> <!-- Un div con la clase "mostrador" y un atributo "id" de "mostrador" -->
        <div class="fila"> <!-- Un div con la clase "fila" -->
            ...
            <div class="item" onclick="cargar(this)">
                ...
                <p class="descripcion">Leche en bolsa alqueria megalitro de 1100ml</p>
                <span class="precio">$ 6.000</span>
                <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('ARROZ FLORHUILA', 1800,'img/arrozflorhuila.png')">Agregar al Carrito</button>
            </div>
            <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                        <img src="img/yogo.png" alt="">
                    </div>
                    <p class="descripcion">Yogurt yogo yogo en vaso 150g</p>
                    <span class="precio">$ 1.800</span>
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Yogurt yogo yogo en vaso 150g', 1800,'img/yogo.png')">Agregar al Carrito</button>
                </div>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                        <img src="img/queso.png" alt="">
                    </div>
                    <p class="descripcion">Queso campesino entero colanta</p>
                    <span class="precio">$ 4.300</span>
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Queso campesino entero colanta', 4300,'img/queso.png')">Agregar al Carrito</button>
                </div>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                        <img src="img/salchichaz.png" alt="">
                    </div>
                    <p class="descripcion">Salchicha perro caliente Zenu de 2</p>
                    <span class="precio">$ 3.000</span>
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Salchicha perro caliente Zenu de 2', 3000,'img/salchichaz.png')">Agregar al Carrito</button>
                </div>
            </div>
            <div class="fila">
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                        <img src="img/bonyurt.png" alt="">
                    </div>
                    <p class="descripcion">Bon yurt Alpina de 169g </p>
                    <span class="precio">$ 3.800</span>
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Bon yurt Alpina de 169g', 3800,'img/bonyurt.png')">Agregar al Carrito</button>
                </div>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                        <img src="img/alpinito.png" alt="">
                    </div>
                    <p class="descripcion">Alpinito Alpina de 45g</p>
                    <span class="precio">$ 18.000</span>
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Alpinito Alpina de 45g', 18000,'img/alpinito.png')">Agregar al Carrito</button>
                </div>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                        <img src="img/mym.png" alt="">
                    </div>
                    <p class="descripcion">Yogurt MyM de 100g</p>
                    <span class="precio">$ 3.000</span>
                    <button  class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Yogurt MyM de 100g', 3000,'img/mym.png')">Agregar al Carrito</button>
                </div>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                        <img src="img/yoalque.png" alt="">
                    </div>
                    <p class="descripcion">Yogurt Alquería en vaso de 1150g</p>
                    <span class="precio">$ 2.500</span>
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Yogurt Alquería en vaso de 1150g', 2500,'img/yoalque.png')">Agregar al Carrito</button>
                </div>
            </div> 
        </div>
