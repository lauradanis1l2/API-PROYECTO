...
<body>
    <body>
            ...
            <h1>PERFIL USUARIO</h1> <br> <!-- Encabezado de nivel 1 (h1) con el texto "Bienvenido a JC" -->
<br>
<br>
            <a class="boton" href="inicioD.php">Inicio</a><!--PERMITE VOLVER A LA VISTA EL MENU---> <br>
            <br>
            <br>
</div>
...
<tr>
    ...
    &nbsp;
        ...
        <a href="../Vista/EditarUsuario.php?idUsuario=<?php echo $r['idUsuario'];?>">Editar</a><!--INDICA QUE CONTROLADOR Y QUE ACCION EJECUTAR,
