    ...
    <div class="mostrador" id="mostrador"> <!-- Un div con la clase "mostrador" y un atributo "id" de "mostrador" -->
        <div class="fila"> <!-- Un div con la clase "fila" -->
            ...
            <div class="item" onclick="cargar(this)">
                ...
                <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('De todito personal de 45g', 2600,'img/detodito.png')">Agregar al Carrito</button>
            </div>
            <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                    ...
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Choclitos de limón personal de 27g', 1700,'img/choclitos.png')">Agregar al Carrito</button>
                </div>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                    ...
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Todo rico personal de 250g ', 2500,'img/rico.png')">Agregar al Carrito</button>
                </div>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                    ...
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Chocorramo de 65g', 2000,'img/chocorramo.png')">Agregar al Carrito</button>
                </div>
            </div>
            <div class="fila">
                <div class="item" onclick="cargar(this)">
                    ...
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Ponqué Marinela pekitas de 33g', 1600,'img/pekita.png')">Agregar al Carrito</button>
                </div>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                    ...
                    <button  class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Ponqué casero bimbo de 220g', 4800,'img/casero.png')">Agregar al Carrito</button>
                </div>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                    ...
                    <button  class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Paquete de gomitas trululu de 90g', 2200,'img/gomita.png')">Agregar al Carrito</button>
                </div>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                    ...
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Chocolatina Jumbo mani 40g', 2800,'img/jumbo.png')">Agregar al Carrito</button>
                </div>
            </div> 
        </div>
        </div>
