...
<div class="logo"> <!-- Un div con la clase "logo" -->
    <img src="img/logoe.png" class="circle3-image" alt="Imagen circular"> <!-- Una imagen con la clase "circle3-image" y una descripción alternativa -->
        ...
        <div class="fila"> <!-- Un div con la clase "fila" -->
            ...
            <div class="item" onclick="cargar(this)"> <!-- Un div con la clase "item" y un atributo "onclick" -->
                <div class="contenedor-foto"> <!-- Un div con la clase "contenedor-foto" -->
                    <img src="img/faldajerseyba.png" alt=""><!-- Una imagen con una ruta "src" y una descripción alternativa "alt" -->
                </div> <!-- Cierre del div "contenedor-foto" -->
                <p class="descripcion">Falda Tejida de Lana Clásica</p> <!-- Un párrafo con la clase "descripcion" -->
                <span class="precio">$ 80.500</span> <!-- Un span con la clase "precio" -->
               <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Falda Tejida de Lana Clásica', 80500,'img/faldajerseyba.png')">Agregar al Carrito</button>
            </div> <!-- Cierre del primer "item" -->
            <!-- Los siguientes elementos siguen un patrón similar -->
            <!-- Segundo elemento -->
            <div class="item" onclick="cargar(this)">
                <div class="contenedor-foto">
                    <img src="img/faldatejidapli.png" alt="">
                </div>
                <p class="descripcion">Falda Jersey Básica</p>
                <span class="precio">$ 90.000</span>
                <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Falda Tejida de Lana Clásica', 90000,'img/faldatejidapli.png')">Agregar al Carrito</button>
            </div>

            <!-- Tercer elemento -->
            <div class="item" onclick="cargar(this)">
                <div class="contenedor-foto">
                    <img src="img/plisada.png" alt="">
                </div>
                <p class="descripcion">Falda Tejida Plisada</p>
                <span class="precio">$ 70.000</span>
               <button  class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Falda Tejida Plisada', 70000,'img/plisada.png')">Agregar al Carrito</button>
            </div>

            <!-- Cuarto elemento -->
            <div class="item" onclick="cargar(this)">
                <div class="contenedor-foto">
                    <img src="img/hiloajustada.png" alt="">
                </div>
                <p class="descripcion">Falda de Hilo Ajustada</p>
                <span class="precio">$ 80.000</span>
               <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Falda de Hilo Ajustada', 80000,'img/hiloajustada.png')">Agregar al Carrito</button>
            </div>
...
<div class="fila">
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                        <img src="img/faldaoversive.png" alt="">
                    </div>
                    <p class="descripcion">Falda Tejida Oversize</p>
                    <span class="precio">$ 110.000</span>
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Falda Tejida Oversize', 110000,'img/faldaoversive.png')">Agregar al Carrito</button>
                </div>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                        <img src="img/lanacintura.png" alt="">
                    </div>
                    <p class="descripcion">Falda de Lana Cintura Alta</p>
                    <span class="precio">$ 90.000</span>
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Falda de Lana Cintura Alta', 90000,'img/lanacintura.png')">Agregar al Carrito</button>
                </div>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                        <img src="img/faldamidi.png" alt="">
                    </div>
                    <p class="descripcion">Falda Midi Tejida</p>
                    <span class="precio">$ 80.000</span>
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Falda Midi Tejida', 80000, 'img/faldamidi.png')">Agregar al Carrito</button>
                </div>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                        <img src="img/faldaacampanada.png" alt="">
                    </div>
                    <p class="descripcion">Falda Tejida Acampanada</p>
                    <span class="precio">$ 95.000</span>
                   <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Falda Tejida Acampanada', 95000, 'img/faldaacampanada.png')">Agregar al Carrito</button>
                </div>
            </div> 
        </div>
...
.agregar-al-carrito-btn {
    ...
    border: 2px solid brown; /* Borde de color café */
...
.agregar-al-carrito-btn:hover {
    background-color: brown; /* Cambia el fondo a café al pasar el ratón sobre el botón */
    color: beige; /* Cambia el texto a beige al pasar el ratón sobre el botón */
}
