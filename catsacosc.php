...
<title>CATEGORIA SACOS</title> <!-- Título de la página -->
</head> <!-- Fin de la cabeza del documento -->
        ...
        <div class="fila"> <!-- Un div con la clase "fila" -->
            ...
            <div class="item" onclick="cargar(this)">
                <div class="contenedor-foto">
                    <img src="img/sacolana.png" alt="">
                </div>
                <p class="descripcion">Saco Clásico de Lana</p>
                <span class="precio">$ 80.000</span>
                <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Saco Clásico de Lana', 80000,'img/sacolana.png')">Agregar al Carrito</button>
            </div>
            <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                        <img src="img/sacohilodelgado.png" alt="">
                    </div>
                    <p class="descripcion">Saco Tejido de Hilo Delgado</p>
                    <span class="precio">$ 75.000</span>
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Saco Tejido de Hilo Delgado', 75000,'img/sacohilodelgado.png')">Agregar al Carrito</button>
                </div>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                        <img src="img/sacojersey.png" alt="">
                    </div>
                    <p class="descripcion">Saco Jersey Básico</p>
                    <span class="precio">$ 60.000</span>
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Saco Jersey Básico', 60000,'img/sacojersey.png')">Agregar al Carrito</button>
                </div>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                        <img src="img/sacolanacuello.png" alt="">
                    </div>
                    <p class="descripcion">Saco de Lana Cuello Alto</p>
                    <span class="precio">$ 75.000</span>
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Saco de Lana Cuello Alto', 75000,'img/sacolanacuello.png')">Agregar al Carrito</button>
                </div>
            </div>
            <div class="fila">
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                        <img src="img/sacooversize.png" alt="">
                    </div>
                    <p class="descripcion">Saco Tejido Oversize</p>
                    <span class="precio">$ 90.000</span>
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Saco Tejido Oversize', 9000,'img/sacooversize.png')">Agregar al Carrito</button>
                </div>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                        <img src="img/sacobotones.png" alt="">
                    </div>
                    <p class="descripcion">Saco Jersey con Botones</p>
                    <span class="precio">$ 90.000</span>
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Saco Jersey con Botones', 90000,'img/sacobotones.png')">Agregar al Carrito</button>
                </div>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                        <img src="img/sacovintage.png" alt="">
                    </div>
                    <p class="descripcion">Saco de Lana Estilo Vintage</p>
                    <span class="precio">$ 95.000</span>
                    <button  class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Saco de Lana Estilo Vintage', 95000,'img/sacovintage.png')">Agregar al Carrito</button>
                </div>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                        <img src="img/sacotrenzado.png" alt="">
                    </div>
                    <p class="descripcion">Saco Tejido con Textura (Trenzado)</p>
                    <span class="precio">$ 95.000</span>
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Saco Tejido con Textura ', 95000,'img/sacotrenzado.png')">Agregar al Carrito</button>
                </div>
            </div> 
        </div>
