...
<body>
    <body>
            ...
            <img src="./img/domicilios.jpg" class="circle-image" alt="Imagen circular"> <!-- Una imagen circular con una clase "circle-image" y una ruta de origen ("src") -->
...
<tr>
    ...
    <td>
        <a class="boton" href="EditarDomicilio.php?idDomicilio=<?php echo $r['idDomicilio'];?>">Editar</a><!--INDICA QUE CONTROLADOR Y QUE ACCION EJECUTAR,
        EN ESTE CASO LLAMARIA AL ARCHIVO EDITAUSUARIO.PHP PASANDO EL ID COMO PARAMETRO---> 
    </td>
    <td>
        <a class="boton" href="EliminarDomicilio.php?idDomicilio=<?php echo $r['idDomicilio'];?>">Eliminar</a><!--INDICA QUE CONTROLADOR Y QUE ACCION
