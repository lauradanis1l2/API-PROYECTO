...
<title>CATEGORIA PANTALONES</title> <!-- Título de la página -->
</head> <!-- Fin de la cabeza del documento -->
        ...
        <div class="fila"> <!-- Un div con la clase "fila" -->
            ...
            <div class="item" onclick="cargar(this)">
                <div class="contenedor-foto">
                    <img src="img/panlacla.png" alt="">
                </div>
                <p class="descripcion">Pantalón Tejido de Lana Clásico</p>
                <span class="precio">$ 70.000</span>
                <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Pantalón Tejido de Lana Clásico', 70000,'img/panlacla.png')">Agregar al Carrito</button>
            </div>
            <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                        <img src="img/panjerba.png" alt="">
                    </div>
                    <p class="descripcion">Pantalón Jersey Básico</p>
                    <span class="precio">$ 65.000</span>
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Pantalón Jersey Básico', 65000,'img/panjerba.png')">Agregar al Carrito</button>
                </div>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                        <img src="img/pantere.png" alt="">
                    </div>
                    <p class="descripcion">Pantalón Tejido Recto Elegante</p>
                    <span class="precio">$ 70.500</span>
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Pantalón Tejido Recto Elegante', 70500,'img/pantere.png')">Agregar al Carrito</button>
                </div>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                        <img src="img/panhiaj.png" alt="">
                    </div>
                    <p class="descripcion">Pantalón de Hilo Ajustado</p>
                    <span class="precio">$ 70.000</span>
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Pantalón de Hilo Ajustado', 70.00,'img/panhiaj.png')">Agregar al Carrito</button>
                </div>
            </div>
            <div class="fila">
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                        <img src="img/panteov.png" alt="">
                    </div>
                    <p class="descripcion">Pantalón Tejido Oversize</p>
                    <span class="precio">$ 70.000</span>
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Pantalón Tejido Oversize', 70000,'img/panteov.png')">Agregar al Carrito</button>
                </div>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                        <img src="img/cinturaalta.png" alt="">
                    </div>
                    <p class="descripcion">Pantalón de Lana con Cintura Alta</p>
                    <span class="precio">$ 87.000</span>
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Pantalón de Lana con Cintura Alta', 87000,'img/cinturaalta.png')">Agregar al Carrito</button>
                </div>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                        <img src="img/panjogger.png" alt="">
                    </div>
                    <p class="descripcion">Pantalón Jogger Tejido</p>
                    <span class="precio">$ 65.500</span>
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Pantalón Jogger Tejido', 65500,'img/panjogger.png')">Agregar al Carrito</button>
                </div>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                        <img src="img/acampanado.png" alt="">
                    </div>
                    <p class="descripcion">Pantalón Tejido Acampanado</p>
                    <span class="precio">$ 80.000</span>
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Pantalón Tejido Acampanado', 80000,'img/acampanado.png')">Agregar al Carrito</button>
                </div>
            </div> 
        </div>
...
<head> <!-- Etiqueta de cabeza de HTML que contiene metainformación -->
  ...
  <ul class="meniu"> <!-- Una lista no ordenada (ul) con la clase "meniu" -->
    ...
    <li class="menu-item"><a href="inicioC.php">Salir</a></li> <!-- Otro elemento de lista similar para "Salir" -->
