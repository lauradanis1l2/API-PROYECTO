...
<title>CATEGORIA CAMISAS</title> <!-- Título de la página -->
</head> <!-- Fin de la cabeza del documento -->
        ...
        <div class="fila"> <!-- Un div con la clase "fila" -->
            ...
            <div class="item" onclick="cargar(this)">
                <div class="contenedor-foto">
                    <img src="img/camisablanca.png" alt="">
                </div>
                <p class="descripcion">Camisa Clásica Blanca</p>
                <span class="precio">$ 85.000</span>
                <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Camisa Clásica Blanca', 85000,'img/camisablanca.png')">Agregar al Carrito</button>
            </div>
            <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                        <img src="img/camisacasual.png" alt="">
                    </div>
                    <p class="descripcion">Camisa Casual de Manga Corta</p>
                    <span class="precio">$ 60.000</span>
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Camisa Casual de Manga Corta', 60000,'img/camisacasual.png')">Agregar al Carrito</button>
                </div>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                        <img src="img/camisaslim.png" alt="">
                    </div>
                    <p class="descripcion">Camisa Slim Fit Negra</p>
                    <span class="precio">$ 85.000</span>
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Camisa Slim Fit Negra', 85000,'img/camisaslim.png')">Agregar al Carrito</button>
                </div>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                        <img src="img/camisacuadros.png" alt="">
                    </div>
                    <p class="descripcion">Camisa a Cuadros</p>
                    <span class="precio">$ 90.000</span>
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Camisa a Cuadros', 90000,'img/camisacuadros.png')">Agregar al Carrito</button>
                </div>
            </div>
            <div class="fila">
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                        <img src="img/camisadenim.png" alt="">
                    </div>
                    <p class="descripcion">Camisa Denim (Jean)</p>
                    <span class="precio">$ 70.000</span>
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Camisa Denim (Jean)', 70000,'img/camisadenim.png')">Agregar al Carrito</button>
                </div>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                        <img src="img/camisaestampada.png" alt="">
                    </div>
                    <p class="descripcion">Camisa Estampada</p>
                    <span class="precio">$ 90.000</span>
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Camisa Estampada', 90000,'img/camisaestampada.png')">Agregar al Carrito</button>
                </div>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                        <img src="img/camisaformal.png" alt="">
                    </div>
                    <p class="descripcion">Camisa Formal Azul</p>
                    <span class="precio">$ 90.000</span>
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Camisa Formal Azul', 90000,'img/camisaformal.png')">Agregar al Carrito</button>
                </div>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                        <img src="img/camisalino.png" alt="">
                    </div>
                    <p class="descripcion">Camisa Lino</p>
                    <span class="precio">$ 95.000</span>
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Camisa Lino',95000,'img/camisalino.png')">Agregar al Carrito</button>
                </div>
            </div> 
        </div>
