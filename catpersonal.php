...
<title>CATEGORIA CUIDADO PERSONAL Y ASEO</title> <!-- Título de la página -->
</head> <!-- Fin de la cabeza del documento -->
        ...
        <div class="fila"> <!-- Un div con la clase "fila" -->
            ...
            <div class="item" onclick="cargar(this)">
                <div class="contenedor-foto">
                    <img src="img/cepillo.png" alt="">
                </div>
                <p class="descripcion">Cepillo dental colgate</p>
                <span class="precio">$ 2.600</span>
                <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Cepillo dental colgate', 2600,'img/cepillo.png')">Agregar al Carrito</button>
            </div>
            <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                        <img src="img/crema.png" alt="">
                    </div>
                    <p class="descripcion">Crema dental colgate triple acción de 60ml</p>
                    <span class="precio">$ 4.500</span>
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Crema dental colgate triple acción de 60ml', 4500,'img/crema.png')">Agregar al Carrito</button>
                </div>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                        <img src="img/desodoh.png" alt="">
                    </div>
                    <p class="descripcion">Desodorante de hombre speed stick de 70g</p>
                    <span class="precio">$ 3.500</span>
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Desodorante de hombre speed stick de 70g', 3500,'img/desodoh.png')">Agregar al Carrito</button>
                </div>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                        <img src="img/desodom.png" alt="">
                    </div>
                    <p class="descripcion">Desodorante de mujer lady speed stick de 70g</p>
                    <span class="precio">$ 3.500</span>
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Desodorante de mujer lady speed stick de 70g', 3500,'img/desodom.png')">Agregar al Carrito</button>
                </div>
            </div>
            <div class="fila">
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                        <img src="img/ego.png" alt="">
                    </div>
                    <p class="descripcion">Gel ego en sachet </p>
                    <span class="precio">$ 1.200</span>
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Gel ego en sachet', 1200,'img/ego.png')">Agregar al Carrito</button>
                </div>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                        <img src="img/papelh.png" alt="">
                    </div>
                    <p class="descripcion">Papel higienico elite </p>
                    <span class="precio">$ 2.300</span>
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Papel higienico elite', 2300,'img/papelh.png')">Agregar al Carrito</button>
                </div>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                        <img src="img/protex.png" alt="">
                    </div>
                    <p class="descripcion">Jabon en barra protex</p>
                    <span class="precio">$ 4.000</span>
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Jabon en barra protex', 4000,'img/protex.png')">Agregar al Carrito</button>
                </div>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                        <img src="img/protector.png" alt="">
                    </div>
                    <p class="descripcion">Protector solar arawak en sachet de 10g</p>
                    <span class="precio">$ 2.400</span>
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Protector solar arawak en sachet de 10g', 2400,'img/protector.png')">Agregar al Carrito</button>
                </div>
            </div> 
        </div>
