    ...
    <div class="mostrador" id="mostrador"> <!-- Un div con la clase "mostrador" y un atributo "id" de "mostrador" -->
        <div class="fila"> <!-- Un div con la clase "fila" -->
            ...
            <div class="item" onclick="cargar(this)">
                ...
                <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Pastilla de ibuprofeno de 800mg', 500,'img/ibu.png')">Agregar al Carrito</button>
            </div>
          <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                ...
                <div class="item" onclick="cargar(this)">
                    ...
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Noxpirin panela limón en sobre', 1800,'img/noxpi.png')">Agregar al Carrito</button>
                </div>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                    ...
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Pastilla de aspirina efervescente', 1200,'img/aspirina.png')">Agregar al Carrito</button>
                </div>
            </div>
            <div class="fila">
                <div class="item" onclick="cargar(this)">
                    ...
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Curitas para la piel unidad', 200,'img/curitas.png')">Agregar al Carrito</button>
                </div>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                    ...
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Alcohol antiséptico 350ml', 5000,'img/alcohol.png')">Agregar al Carrito</button>
                </div>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                    ...
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Capsula advil max unidad', 2200,'img/advil.png')">Agregar al Carrito</button>
                </div>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                    ...
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Algodon 50g', 4500,'img/algodon.png')">Agregar al Carrito</button>
                </div>
            </div> 
        </div>
