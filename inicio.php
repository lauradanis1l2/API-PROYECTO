...
<div class="product"> <!-- Un div con la clase "product" -->
    ...
    <a class="boton" href="catpersonal.php">Ir</a> <!-- Un enlace con la clase "boton" que redirige a la página de categoría de Cuidado Personal y Aseo -->
...
<div class="product"> <!-- Un div con la clase "product" -->
    ...
    <a class="boton" href="catlacteos.php">Ir</a> <!-- Un enlace con la clase "boton" que redirige a la página de categoría de Lácteos y Quesos -->
</div> <!-- Fin del div "product" -->
<div class="product">
    <img src="img/cat-9.png" class="product">
    <div class="categoria">Categoría Papeleria</div><br>
     <a class="boton"href="catpapeleria.php">Ir</a>

  </div> <!-- Un div con la clase "fila" -->
<div class="product">
    <img src="img/cat-7.png" class="product">
    <div class="categoria">Categoría Dulces</div><br>
      <a class="boton"href="catdulces.php">Ir</a>
...
<div class="product" >
    ...
    <div class="categoria">Categoría Farmacía</div><br>
      <a class="boton"href="catfarmacia.php">Ir</a>
...
<div class="product"> <!-- Inicio del primer elemento con la clase "product" -->
    ...
    <br> <!-- Salto de línea -->
     <a class="boton" href="catbebidasl.php">Ir</a> <!-- Enlace "Ir" con clase "boton" -->
...
<div class="product"> <!-- Inicio del segundo elemento con la clase "product" -->
    ...
    <br> <!-- Salto de línea -->
   <a class="boton" href="catgranos.php">Ir</a> <!-- Enlace "Ir" con clase "boton" -->
...
<div class="product">
 <!-- Inicio del tercer elemento con la clase "product" -->
    ...
    <br> <!-- Salto de línea -->
   <a class="boton" href="catbemas.php">Ir</a> <!-- Enlace "Ir" con clase "boton" -->
...
<div class="menu"> <!-- Un div con la clase "menu" -->
    ...
    <a class="boton2" href="UsuariosC.php">Gestión de Usuario</a> <!-- Un enlace con la clase "boton2" que redirige a la página de gestión de usuarios -->
