    ...
    <div class="mostrador" id="mostrador"> <!-- Un div con las clases "mostrador" y "id" "mostrador" -->
        <div class="fila"> <!-- Un div con la clase "fila" -->
            ...
            <div class="item" onclick="cargar(this)"> <!-- Un div con la clase "item" y un atributo "onclick" -->
               ...
               <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Gaseosa big cola personal', 1500,'img/bigcola.png')">Agregar al Carrito</button>
            ...
            <div class="item" onclick="cargar(this)">
                ...
                <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Natu malta familiar', 3500,'img/malta.png')">Agregar al Carrito</button>
            </div>
            ...
            <div class="item" onclick="cargar(this)">
               ...
               <button  class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Agua en botella personal brisa', 1300,'img/agua.png')">Agregar al Carrito</button>
            </div>
            ...
            <div class="item" onclick="cargar(this)">
               ...
               <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Agua Saviloe 420ml', 3100,'img/savila.png')">Agregar al Carrito</button>
            </div>
...
<div class="fila">
                <div class="item" onclick="cargar(this)">
                    ...
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Jugo valle personal', 1400,'img/jugova.png')">Agregar al Carrito</button>
                </div>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                    ...
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Aguardiente nectar 375ml', 18000,'img/nectar.png')">Agregar al Carrito</button>
                </div>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                    ...
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Cerveza corona en botella', 4000, 'img/corona.png')">Agregar al Carrito</button>
                </div>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                   ...
                   <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Cerveza poker en lata', 3400, 'img/poker.png')">Agregar al Carrito</button>
                </div>
            </div> 
        </div>
