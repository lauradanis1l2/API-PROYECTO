...
<title>CHALECOS</title> <!-- Título de la página -->
        ...
        <div class="fila"> <!-- Un div con la clase "fila" -->
            ...
            <div class="item" onclick="cargar(this)">
                <div class="contenedor-foto">
                    <img src="img/chalecolana.png" alt="">
                </div>
                <p class="descripcion">Chaleco Tejido de Lana Clásico</p>
                <span class="precio">$ 50.000</span>
                <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Chaleco Tejido de Lana Clásico', 50000,'img/chalecolana.png')">Agregar al Carrito</button>
            </div>
          <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                        <img src="img/chalecohilolige.png" alt="">
                    </div>
                    <p class="descripcion">Chaleco de Hilo Ligero</p>
                    <span class="precio">$ 48.000</span>
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Chaleco de Hilo Ligero', 48000,'img/chalecohilolige.png')">Agregar al Carrito</button>
                </div>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                        <img src="img/chalecooversize.png" alt="">
                    </div>
                    <p class="descripcion">Chaleco Tejido Oversize</p>
                    <span class="precio">$ 50.000</span>
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Chaleco Tejido Oversize', 50000,'img/chalecooversize.png')">Agregar al Carrito</button>
                </div>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                         <img src="img/chalecosin.png" alt="">
                    </div>
                    <p class="descripcion">Chaleco Tipo Sweater Sin Mangas</p>
                    <span class="precio">$ 50.000</span>
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Chaleco Tipo Sweater Sin Mangas', 50000,'img/chalecosin.png')">Agregar al Carrito</button>
                </div>
            </div>
            <div class="fila">
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                        <img src="img/chalecocuellov.png" alt="">
                    </div>
                    <p class="descripcion">Chaleco de Lana Cuello en V</p>
                    <span class="precio">$ 45.000</span>
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Chaleco de Lana Cuello en V', 4500,'img/chalecocuellov.png')">Agregar al Carrito</button>
                </div>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                        <img src="img/chalecobotones.png" alt="">
                    </div>
                    <p class="descripcion">Chaleco Tejido con Botones</p>
                    <span class="precio">$ 52.000</span>
                    <button class="agregar-al-carrito-btn"onclick="agregarAlCarrito('Chaleco Tejido con Botones', 52000,'img/chalecobotones.png')">Agregar al Carrito</button>
                </div>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                          <img src="img/chalecocasual.png" alt="">
                    </div>
                    <p class="descripcion">Chaleco Tejido Casual</p>
                    <span class="precio">$ 50.000</span>
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Chaleco Tejido Casual', 50000,'img/chalecocasual.png')">Agregar al Carrito</button>
                </div>
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor-foto">
                        <img src="img/chalecoelegante.png" alt="">
                    </div>
                    <p class="descripcion">Chaleco Elegante Ajustado</p>
                    <span class="precio">$ 52.000</span>
                    <button class="agregar-al-carrito-btn" onclick="agregarAlCarrito('Chaleco Elegante Ajustado', 52000,'img/chalecoelegante.png')">Agregar al Carrito</button>
                </div>
            </div> 
        </div>
